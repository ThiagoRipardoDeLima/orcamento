...
export class ClienteService {
  ...
  constructor(private http:HttpClient){
    ...
    getClientes(){
        return this.http
                    .get<Cliente[]>(this.baseUrlService)
                    .pipe(map(res => {
                        return res;
                    }));
    }
    ...
    getCliente(codigo:number){
        return this.http
                    .get<Cliente>(this.baseUrlService + codigo)
                    .pipe(map(res => {
                        return res;
                    }));
    }
    ...
    getClienteByNome(descricao:string){
        return this.http
                    .get<Cliente[]>(this.baseUrlService + descricao)
                    .pipe(map(res => {
                        return res;
                    }));
    }
    ...
    getClienteByCPF(cpf:string){
        return this.http
                    .get<Cliente[]>(this.baseUrlService + cpf)
                    .pipe(map(res => {
                        return res;
                    }));
    }
    ...
    addCliente(cliente: Cliente){
        ...
        return this.http
                    .post<any>(this.baseUrlService, JSON.stringify(cliente), this.options)
                    .pipe(map(res => {
                        return res;
                    }));
    ...
    deleteCliente(codigo:number){
        return this.http    
                    .delete(this.baseUrlService + codigo)
                    .pipe(map(res => {
                        return res;
                    }));
    }
    ...
    updateCliente(cliente: Cliente){
        return this.http
                    .put(this.baseUrlService, JSON.stringify(cliente),this.options)
                    .pipe(map(res => {
                        return res
                    }));
    }
